from sqlalchemy_create_tables import stations, engine
...
conn.execute(ins, [
    ...
    {'station':	'USC00513117',	'latitude':	21.4234,	'longitude':-157.801,	'elevation':14.6, 'name':'KANEOHE 838.1', 'country':'US', 'state':'HI'},   
